...
client = LINE("rrezalulloh2326@gmail.com","renaldi2326")
...
# Pembatas Script #
                                ...
                                if msg.toType == 2:
                            	   ...
                            	   pict = client.downloadFileURL("https://i.imgur.com/Zwz10Uc", saveAs="image.jpg")
                            	   vids = client.downloadFileURL("https://redirector.googlevideo.com/videoplayback?lmt=1527031461916143&ip=178.162.205.109&ms=au%2Conr&mv=m&sparams=dur%2Cei%2Cid%2Cinitcwndbps%2Cip%2Cipbits%2Citag%2Clmt%2Cmime%2Cmm%2Cmn%2Cms%2Cmv%2Cpl%2Cratebypass%2Crequiressl%2Csource%2Cexpire&mt=1528467913&itag=22&id=5a87a80a5ab5e8b1&mn=sn-4g5e6nes%2Csn-1gi7znes&dur=175.124&ipbits=0&mm=31%2C26&expire=1528489599&c=WEB&initcwndbps=316250&requiressl=yes&key=yt6&mime=video%2Fmp4&source=youtube&pl=18&fvip=2&ei=H5IaW62xFs6zgQfuno2wBg&ratebypass=yes&signature=825E44BA058D51B00B7A42ADD75AE40F69C4DC94.49A9A67B166972C493A13EF154FAE8A4D83D38C4&title=AMV_%E3%80%8C_The_Devil_Inside_%E3%80%8D_#Aniex_Music", saveAs="video.mp4")
                            	   changeVideoAndPictureProfile(pict, vids)
                            	   client.sendMessage(to,"berhasil mengubah foto profile video")
                            elif cmd == 'grouplist':
